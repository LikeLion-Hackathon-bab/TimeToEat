package com.example.timetoeat.domain.subscription.adap.out.mapper;

import com.example.timetoeat.domain.post.adap.out.persistence.PostEntity;
import com.example.timetoeat.domain.subscription.adap.out.persistence.SubscriptionEntity;
